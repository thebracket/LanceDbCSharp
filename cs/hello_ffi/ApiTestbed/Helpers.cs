...
internal static class Helpers
{
    internal static Schema GetSchema()
    {
        ...
        // Define the FixedSizeListType with the "item" field and a fixed size of 8
        var vectorType = new FixedSizeListType(itemField, listSize: 8);
    ...
    internal static RecordBatch CreateSampleRecordBatch(Schema schema, int start, int total, int dim)
    {
        ...
        {
            floatBuilder.Append((float)i / (float)dim); // Sample value as 1.0
        }
